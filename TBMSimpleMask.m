function [maskedFBank, oriSpectrum, mask] = TBMSimpleMask(wavfname, localSNR, useDynamic)
% 
...
% Target Binary Mask(TBM) in the power spectrum domain before FBank feature 
% extraction. In TBM, the target clean speech is used to compute the local
...
ratio = abs(dataFreq).^2 ./ avgE(ones(numfrm,1),:);
